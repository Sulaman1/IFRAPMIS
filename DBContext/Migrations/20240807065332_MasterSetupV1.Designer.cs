...
namespace DBContext.Migrations
{
    ...
    [Migration("20240807065332_MasterSetupV1")]
    partial class MasterSetupV1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DAL.Models.Domain.MasterSetup.District", b =>
                {
                    b.HasOne("DAL.Models.Domain.MasterSetup.Division", "Division")
                        .WithOne("District")
                        .HasForeignKey("DAL.Models.Domain.MasterSetup.District", "DivisionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Models.Domain.MasterSetup.Division", b =>
                {
                    b.HasOne("DAL.Models.Domain.MasterSetup.Provience", "Provience")
                        .WithOne("Division")
                        .HasForeignKey("DAL.Models.Domain.MasterSetup.Division", "ProvienceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
