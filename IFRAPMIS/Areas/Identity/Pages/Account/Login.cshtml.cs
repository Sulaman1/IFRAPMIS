        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {                    
                    ...
                    //HttpContext.Session.SetInt32("DistrictId", currentUser.DistrictName);
                    HttpContext.Session.SetString("DistrictName", currentUser.DistrictName);
                    string cookieValueFromReq = Request.Cookies["Key"];
                    //set the key value in Cookie  
                    Set("DistrictName", currentUser.DistrictName.ToString(),10);
